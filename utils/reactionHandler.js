...
async function runReaction(input, type) {
    ...
    const reactions = {
        ...
        paint: { text: `traza pinceladas de pura inspiración...`, fallback: 'https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExNHR4M3J4eHh4eHgmcmlkPWdpcGh5LmdpZg/3o7TKMGpxx6r1NEX3G/giphy.gif' },
    ...
    const embed = new EmbedBuilder()
        ...
        .setTimestamp()
        .setFooter({ 
            text: `Fuente: ${attachment ? animeName : 'Internet'} ⊹ Reacción de ${authorMember.displayName}`, 
